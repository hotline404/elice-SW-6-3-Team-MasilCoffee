...
OrderOptionRouter.post(
  ...
  asyncHandler(async (req, res) => {
    ...
    const newOrderOption = await OrderOptionService.createOrderOption(orderOptionData);
...
OrderOptionRouter.put(
  ...
  asyncHandler(async (req, res) => {
    ...
    const updatedOrderOption = await OrderOptionService.updateOrderOption(orderOptionId, updatedData);
...
//   asyncHandler(async (req, res) => {
//     const orderOptionId = req.params.orderOptionId;
//     const deletedOrderOption = await OrderOptionService.deleteOrderOption(orderOptionId);
